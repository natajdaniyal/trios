...
# --------------------------------------------------
# 2. Single Body Momentum
# --------------------------------------------------

momentum_a = momentum_system.body_momentum(
    body_a
)
...
# --------------------------------------------------
# 3. Second Body Momentum
# --------------------------------------------------

momentum_b = momentum_system.body_momentum(
    body_b
)
...
# --------------------------------------------------
# 4. Total System Momentum
# --------------------------------------------------

total_momentum = momentum_system.total_momentum(
    [
        body_a,
        body_b,
    ]
...
# --------------------------------------------------
# 5. Momentum Magnitude
# --------------------------------------------------

magnitude = momentum_system.momentum_magnitude(
    (3, 4)
)
...
empty_momentum = momentum_system.total_momentum(
    None
)

none_body_momentum = momentum_system.body_momentum(
    None
)
