...
STAGE_ONE_CHALLENGES = (
    _challenge(
        ...
        _STAGE_ONE_SHARED_QUESTION,
        {
            "fa": ["جذب", "نزدیک", "می‌کشند", "به هم نزدیک", "همدیگر را می‌کشند"],
    ...
    _challenge(
        ...
        _STAGE_ONE_SHARED_QUESTION,
        {
            "fa": ["دفع", "دور", "هل می‌دهند", "پس می‌زنند", "از هم جدا", "فاصله"],
            "en": ["repel", "apart", "push"],
    ...
    _challenge(
        ...
        _STAGE_ONE_CHALLENGE_THREE_QUESTION,
        {
            "fa": ["همزمان", "دو آهنربای دیگر", "اثر", "تأثیر", "تحت تأثیر", "نیرو", "تعامل", "وابسته", "پیش‌بینی", "پیش بینی"],
